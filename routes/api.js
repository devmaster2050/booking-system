...
const { addTour, getTours, getTourById, deleteTour, updateTour, getTourDates } = require('../controllers/tourController');
const { addBooking, getBookings, getBookingsById } = require('../controllers/bookingController');
